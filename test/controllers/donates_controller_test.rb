...
class DonatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donate" do
    assert_difference('Donate.count') do
      post donates_url, params: { donate: { act_id: @donate.act_id, quantity: @donate.quantity, user_id: @donate.user_id } }
    end
  ...
  test "should update donate" do
    patch donate_url(@donate), params: { donate: { act_id: @donate.act_id, quantity: @donate.quantity, user_id: @donate.user_id } }
